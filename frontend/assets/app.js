...
function updateParlorClock(){const seconds=parlorRemaining(),target=$("#parlorClock");if(target)target.textContent=`${String(Math.floor(seconds/60)).padStart(2,"0")}:${String(seconds%60).padStart(2,"0")}`;}
...
function resumeParlorSession(){renderParlorSession();if(parlorSession&&!parlorSession.stopped)scheduleParlorPoll(50);}
