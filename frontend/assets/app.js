...
function renderHomestead(){
  ...
  $("#homesteadCoins").textContent=current.coins;$("#homesteadAiEnabled").checked=!!current.management?.enabled;$("#homesteadManagerStatus").textContent=current.management?.enabled?`已授权 ${activePersonaName()} 管理 · 每日预算 ${current.management.daily_budget} 云贝`:"现在由你亲自照料";
