...
async function openGame(gameId) {
  ...
  if(gameId==="nowhere"){const frame=$("#nowhereFrame"),source=window.AtherloomNative?`/assets/nowhere/index.html?persona_id=${encodeURIComponent(state.persona||"__default__")}`:"/nowhere/";if(frame.src!==new URL(source,location.href).href)frame.src=source;return;}
...
$("#reloadNowhere").onclick=()=>{const frame=$("#nowhereFrame"),base=window.AtherloomNative?`/assets/nowhere/index.html?persona_id=${encodeURIComponent(state.persona||"__default__")}`:"/nowhere/";frame.src=base+(base.includes("?")?"&":"?")+"reload="+Date.now();};
