...
$inline = [regex]::Replace(
  $inline,
  '<style data-atherloom-bundled="[^"]+">[\s\S]*?</style>',
  "<style data-atherloom-bundled=`"$Version`">`r`n$css`r`n</style>",
  [Text.RegularExpressions.RegexOptions]::Singleline
)
$inline = [regex]::Replace(
  $inline,
  '<script data-atherloom-bundled="standalone">[\s\S]*?</script>',
  "<script data-atherloom-bundled=`"standalone`">`r`n$standalone`r`n</script>",
  [Text.RegularExpressions.RegexOptions]::Singleline
)
$inline = [regex]::Replace(
  $inline,
  '<script data-atherloom-bundled="app">[\s\S]*?</script>',
  "<script data-atherloom-bundled=`"app`">`r`n$app`r`n</script>",
  [Text.RegularExpressions.RegexOptions]::Singleline
)
